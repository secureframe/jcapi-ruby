...
module JCAPIv2
  class DuoApi
    ...
    def d_elete_duo_accounts_account_id_applications_application_id(account_id, application_id, accept, content_type, opts = {})
      data, _status_code, _headers = d_elete_duo_accounts_account_id_applications_application_id_with_http_info(account_id, application_id, accept, content_type, opts)
      return data
    end
    ...
    def d_elete_duo_accounts_account_id_applications_application_id_with_http_info(account_id, application_id, accept, content_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DuoApi.d_elete_duo_accounts_account_id_applications_application_id ..."
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling DuoApi.d_elete_duo_accounts_account_id_applications_application_id"
      end
      # verify the required parameter 'application_id' is set
      if @api_client.config.client_side_validation && application_id.nil?
        fail ArgumentError, "Missing the required parameter 'application_id' when calling DuoApi.d_elete_duo_accounts_account_id_applications_application_id"
      end
      # verify the required parameter 'accept' is set
      if @api_client.config.client_side_validation && accept.nil?
        fail ArgumentError, "Missing the required parameter 'accept' when calling DuoApi.d_elete_duo_accounts_account_id_applications_application_id"
      end
      # verify the required parameter 'content_type' is set
      if @api_client.config.client_side_validation && content_type.nil?
        fail ArgumentError, "Missing the required parameter 'content_type' when calling DuoApi.d_elete_duo_accounts_account_id_applications_application_id"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DuoApi#d_elete_duo_accounts_account_id_applications_application_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [String] :x_org_id  (default to )
    # @return [DuoAccount]
    def d_elete_duo_accounts_id(id, accept, content_type, opts = {})
      data, _status_code, _headers = d_elete_duo_accounts_id_with_http_info(id, accept, content_type, opts)
      return data
    end
    ...
    def d_elete_duo_accounts_id_with_http_info(id, accept, content_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DuoApi.d_elete_duo_accounts_id ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DuoApi.d_elete_duo_accounts_id"
      end
      # verify the required parameter 'accept' is set
      if @api_client.config.client_side_validation && accept.nil?
        fail ArgumentError, "Missing the required parameter 'accept' when calling DuoApi.d_elete_duo_accounts_id"
      end
      # verify the required parameter 'content_type' is set
      if @api_client.config.client_side_validation && content_type.nil?
        fail ArgumentError, "Missing the required parameter 'content_type' when calling DuoApi.d_elete_duo_accounts_id"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DuoApi#d_elete_duo_accounts_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :x_org_id  (default to )
    # @return [DuoAccount]
    def p_ost_duo_accounts(accept, content_type, opts = {})
      data, _status_code, _headers = p_ost_duo_accounts_with_http_info(accept, content_type, opts)
      return data
    end
    ...
    # @option opts [String] :x_org_id 
    # @return [Array<(DuoAccount, Fixnum, Hash)>] DuoAccount data, response status code and response headers
    def p_ost_duo_accounts_with_http_info(accept, content_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DuoApi.p_ost_duo_accounts ..."
      end
      # verify the required parameter 'accept' is set
      if @api_client.config.client_side_validation && accept.nil?
        fail ArgumentError, "Missing the required parameter 'accept' when calling DuoApi.p_ost_duo_accounts"
      end
      # verify the required parameter 'content_type' is set
      if @api_client.config.client_side_validation && content_type.nil?
        fail ArgumentError, "Missing the required parameter 'content_type' when calling DuoApi.p_ost_duo_accounts"
      end
      # resource path
      local_var_path = "/duo/accounts"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'DuoAccount')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DuoApi#p_ost_duo_accounts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :x_org_id  (default to )
    # @return [DuoApplication]
    def p_ost_duo_accounts_account_id_applications(account_id, accept, content_type, opts = {})
      data, _status_code, _headers = p_ost_duo_accounts_account_id_applications_with_http_info(account_id, accept, content_type, opts)
      return data
    end
    ...
    # @option opts [String] :x_org_id 
    # @return [Array<(DuoApplication, Fixnum, Hash)>] DuoApplication data, response status code and response headers
    def p_ost_duo_accounts_account_id_applications_with_http_info(account_id, accept, content_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DuoApi.p_ost_duo_accounts_account_id_applications ..."
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling DuoApi.p_ost_duo_accounts_account_id_applications"
      end
      # verify the required parameter 'accept' is set
      if @api_client.config.client_side_validation && accept.nil?
        fail ArgumentError, "Missing the required parameter 'accept' when calling DuoApi.p_ost_duo_accounts_account_id_applications"
      end
      # verify the required parameter 'content_type' is set
      if @api_client.config.client_side_validation && content_type.nil?
        fail ArgumentError, "Missing the required parameter 'content_type' when calling DuoApi.p_ost_duo_accounts_account_id_applications"
      end
      # resource path
      local_var_path = "/duo/accounts/{account_id}/applications".sub('{' + 'account_id' + '}', account_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'DuoApplication')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DuoApi#p_ost_duo_accounts_account_id_applications\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :x_org_id  (default to )
    # @return [DuoApplication]
    def p_ut_duo_accounts_account_id_applications_application_id(account_id, application_id, accept, content_type, opts = {})
      data, _status_code, _headers = p_ut_duo_accounts_account_id_applications_application_id_with_http_info(account_id, application_id, accept, content_type, opts)
      return data
    end
    ...
    # @option opts [String] :x_org_id 
    # @return [Array<(DuoApplication, Fixnum, Hash)>] DuoApplication data, response status code and response headers
    def p_ut_duo_accounts_account_id_applications_application_id_with_http_info(account_id, application_id, accept, content_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DuoApi.p_ut_duo_accounts_account_id_applications_application_id ..."
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling DuoApi.p_ut_duo_accounts_account_id_applications_application_id"
      end
      # verify the required parameter 'application_id' is set
      if @api_client.config.client_side_validation && application_id.nil?
        fail ArgumentError, "Missing the required parameter 'application_id' when calling DuoApi.p_ut_duo_accounts_account_id_applications_application_id"
      end
      # verify the required parameter 'accept' is set
      if @api_client.config.client_side_validation && accept.nil?
        fail ArgumentError, "Missing the required parameter 'accept' when calling DuoApi.p_ut_duo_accounts_account_id_applications_application_id"
      end
      # verify the required parameter 'content_type' is set
      if @api_client.config.client_side_validation && content_type.nil?
        fail ArgumentError, "Missing the required parameter 'content_type' when calling DuoApi.p_ut_duo_accounts_account_id_applications_application_id"
      end
      # resource path
      local_var_path = "/duo/accounts/{account_id}/applications/{application_id}".sub('{' + 'account_id' + '}', account_id.to_s).sub('{' + 'application_id' + '}', application_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'DuoApplication')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DuoApi#p_ut_duo_accounts_account_id_applications_application_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
