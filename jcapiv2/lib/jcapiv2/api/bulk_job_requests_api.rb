...
module JCAPIv2
  class BulkJobRequestsApi
    ...
    # @option opts [String] :x_org_id  (default to )
    # @return [JobId]
    def p_atch_bulk_users(accept, content_type, opts = {})
      data, _status_code, _headers = p_atch_bulk_users_with_http_info(accept, content_type, opts)
      return data
    end
    ...
    def p_atch_bulk_users_with_http_info(accept, content_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: BulkJobRequestsApi.p_atch_bulk_users ..."
      end
      # verify the required parameter 'accept' is set
      if @api_client.config.client_side_validation && accept.nil?
        fail ArgumentError, "Missing the required parameter 'accept' when calling BulkJobRequestsApi.p_atch_bulk_users"
      end
      # verify the required parameter 'content_type' is set
      if @api_client.config.client_side_validation && content_type.nil?
        fail ArgumentError, "Missing the required parameter 'content_type' when calling BulkJobRequestsApi.p_atch_bulk_users"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :return_type => 'JobId')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BulkJobRequestsApi#p_atch_bulk_users\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :x_org_id  (default to )
    # @return [JobId]
    def p_ost_bulk_users(accept, content_type, opts = {})
      data, _status_code, _headers = p_ost_bulk_users_with_http_info(accept, content_type, opts)
      return data
    end
    ...
    # @option opts [String] :x_org_id 
    # @return [Array<(JobId, Fixnum, Hash)>] JobId data, response status code and response headers
    def p_ost_bulk_users_with_http_info(accept, content_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: BulkJobRequestsApi.p_ost_bulk_users ..."
      end
      # verify the required parameter 'accept' is set
      if @api_client.config.client_side_validation && accept.nil?
        fail ArgumentError, "Missing the required parameter 'accept' when calling BulkJobRequestsApi.p_ost_bulk_users"
      end
      # verify the required parameter 'content_type' is set
      if @api_client.config.client_side_validation && content_type.nil?
        fail ArgumentError, "Missing the required parameter 'content_type' when calling BulkJobRequestsApi.p_ost_bulk_users"
      end
      # resource path
      local_var_path = "/bulk/users"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'JobId')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BulkJobRequestsApi#p_ost_bulk_users\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
