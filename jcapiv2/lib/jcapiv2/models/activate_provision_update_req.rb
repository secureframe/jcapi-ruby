...
module JCAPIv2
  ...
  class ActivateProvisionUpdateReq
    ...
    def list_invalid_properties
      ...
      if @vanity_url.nil?
        invalid_properties.push("invalid value for 'vanity_url', vanity_url cannot be nil.")
      end
    ...
    def valid?
      return false if @vanity_url.nil?
