...
module JCAPIv2
  ...
  class UserGroup
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["user_group"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["user_group"])
    ...
    def hash
      [attributes, email, description, id, name, type].hash
    end
