...
module JCAPIv2
  ...
  class Office365Output
    ...
    def list_invalid_properties
      ...
      if @user_lockout_action.nil?
        invalid_properties.push("invalid value for 'user_lockout_action', user_lockout_action cannot be nil.")
      end

      if @user_password_expiration_action.nil?
        invalid_properties.push("invalid value for 'user_password_expiration_action', user_password_expiration_action cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @user_lockout_action.nil?
      ...
      return false if @user_password_expiration_action.nil?
