...
# Unit tests for JCAPIv2::Office365Output
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Office365Output' do
  before do
    # run before each test
    @instance = JCAPIv2::Office365Output.new
  end
  ...
  describe 'test an instance of Office365Output' do
    it 'should create an instance of Office365Output' do
      expect(@instance).to be_instance_of(JCAPIv2::Office365Output)
    end
  end
