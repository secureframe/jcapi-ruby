...
# Unit tests for JCAPIv2::Office365PatchInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Office365PatchInput' do
  before do
    # run before each test
    @instance = JCAPIv2::Office365PatchInput.new
  end
  ...
  describe 'test an instance of Office365PatchInput' do
    it 'should create an instance of Office365PatchInput' do
      expect(@instance).to be_instance_of(JCAPIv2::Office365PatchInput)
    end
  end
