...
describe 'WorkdayImportApi' do
  ...
  # unit tests for d_elete_workdays_workday_id_auth
  # Deauthorize Workday
  ...
  # @return [nil]
  describe 'd_elete_workdays_workday_id_auth test' do
    it "should work" do
  ...
  # @option opts [String] :x_org_id 
  # @return [WorkdayOutput]
  describe 'p_ost_workdays test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ost_workdays_workday_id_auth
  # Authorize Workday
  ...
  # @option opts [String] :x_org_id 
  # @return [nil]
  describe 'p_ost_workdays_workday_id_auth test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ost_workdays_workday_id_import
  # Workday Import
  ...
  # @option opts [String] :x_org_id 
  # @return [JobId]
  describe 'p_ost_workdays_workday_id_import test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ut_workdays_id
  # Update Workday
  ...
  # @option opts [String] :x_org_id 
  # @return [WorkdayOutput]
  describe 'p_ut_workdays_id test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
