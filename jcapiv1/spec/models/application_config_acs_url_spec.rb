...
# Unit tests for JCAPIv1::ApplicationConfigAcsUrl
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApplicationConfigAcsUrl' do
  before do
    # run before each test
    @instance = JCAPIv1::ApplicationConfigAcsUrl.new
  end
  ...
  describe 'test an instance of ApplicationConfigAcsUrl' do
    it 'should create an instance of ApplicationConfigAcsUrl' do
      expect(@instance).to be_instance_of(JCAPIv1::ApplicationConfigAcsUrl)
    end
  end
