...
# Unit tests for JCAPIv1::Radiusserver
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Radiusserver' do
  before do
    # run before each test
    @instance = JCAPIv1::Radiusserver.new
  end
  ...
  describe 'test an instance of Radiusserver' do
    it 'should create an instance of Radiusserver' do
      expect(@instance).to be_instance_of(JCAPIv1::Radiusserver)
    end
  end
