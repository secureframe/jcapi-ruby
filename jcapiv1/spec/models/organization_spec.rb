...
# Unit tests for JCAPIv1::Organization
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Organization' do
  before do
    # run before each test
    @instance = JCAPIv1::Organization.new
  end
  ...
  describe 'test an instance of Organization' do
    it 'should create an instance of Organization' do
      expect(@instance).to be_instance_of(JCAPIv1::Organization)
    end
  end
  ...
  describe 'test attribute "has_stripe_customer_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
