...
# Unit tests for JCAPIv1::Applicationtemplate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Applicationtemplate' do
  before do
    # run before each test
    @instance = JCAPIv1::Applicationtemplate.new
  end
  ...
  describe 'test an instance of Applicationtemplate' do
    it 'should create an instance of Applicationtemplate' do
      expect(@instance).to be_instance_of(JCAPIv1::Applicationtemplate)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["", "end_of_life", "end_of_support", "beta"])
  ...
  describe 'test attribute "jit"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
