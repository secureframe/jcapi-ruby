...
# Unit tests for JCAPIv1::CommandresultslistResults
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommandresultslistResults' do
  before do
    # run before each test
    @instance = JCAPIv1::CommandresultslistResults.new
  end
  ...
  describe 'test an instance of CommandresultslistResults' do
    it 'should create an instance of CommandresultslistResults' do
      expect(@instance).to be_instance_of(JCAPIv1::CommandresultslistResults)
    end
  end
