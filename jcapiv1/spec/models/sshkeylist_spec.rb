...
# Unit tests for JCAPIv1::Sshkeylist
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Sshkeylist' do
  before do
    # run before each test
    @instance = JCAPIv1::Sshkeylist.new
  end
  ...
  describe 'test an instance of Sshkeylist' do
    it 'should create an instance of Sshkeylist' do
      expect(@instance).to be_instance_of(JCAPIv1::Sshkeylist)
    end
  end
