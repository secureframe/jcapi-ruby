...
module JCAPIv1
  ...
  class Organization
    ...
    attr_accessor :has_stripe_customer_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hasStripeCustomerId')
        self.has_stripe_customer_id = attributes[:'hasStripeCustomerId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          has_stripe_customer_id == o.has_stripe_customer_id &&
          logo_url == o.logo_url &&
          provider == o.provider &&
          settings == o.settings
    end
    ...
    def hash
      [_id, created, display_name, has_stripe_customer_id, logo_url, provider, settings].hash
    end
