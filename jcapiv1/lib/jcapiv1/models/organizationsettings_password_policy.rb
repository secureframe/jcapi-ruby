...
module JCAPIv1
  ...
  class OrganizationsettingsPasswordPolicy
    ...
    def hash
      [allow_username_substring, days_after_expiration_to_self_recover, days_before_expiration_to_force_reset, effective_date, enable_days_after_expiration_to_self_recover, enable_days_before_expiration_to_force_reset, enable_lockout_time_in_seconds, enable_max_history, enable_max_login_attempts, enable_min_change_period_in_days, enable_min_length, enable_password_expiration_in_days, lockout_time_in_seconds, max_history, max_login_attempts, min_change_period_in_days, min_length, needs_lowercase, needs_numeric, needs_symbolic, needs_uppercase, password_expiration_in_days].hash
    end
