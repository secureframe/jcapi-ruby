...
module JCAPIv1
  ...
  class ApplicationtemplateJit
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'createOnly')
        self.create_only = attributes[:'createOnly']
      end
