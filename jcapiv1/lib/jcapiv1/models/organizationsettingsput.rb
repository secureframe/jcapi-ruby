...
module JCAPIv1
  ...
  class Organizationsettingsput
    ...
    def hash
      [contact_email, contact_name, disable_ldap, disable_um, duplicate_ldap_groups, email_disclaimer, enable_managed_uid, features, logo, name, password_compliance, password_policy, show_intro, system_user_password_expiration_in_days, system_users_can_edit, disable_google_login, user_portal, device_identification_enabled].hash
    end
