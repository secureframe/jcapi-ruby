...
module JCAPIv1
  ...
  class Systemuserreturn
    ...
    def hash
      [_id, account_locked, activated, addresses, allow_public_key, attributes, bad_login_attempts, company, cost_center, created, department, description, displayname, email, employee_identifier, employee_type, enable_managed_uid, enable_user_portal_multifactor, external_dn, external_password_expiration_date, external_source_type, externally_managed, firstname, job_title, lastname, ldap_binding_user, location, mfa, middlename, organization, password_expiration_date, password_expired, password_never_expires, passwordless_sudo, phone_numbers, public_key, relationships, samba_service_user, ssh_keys, sudo, suspended, tags, totp_enabled, unix_guid, unix_uid, username].hash
    end
