...
module JCAPIv1
  ...
  class Modelcase
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'replyTime')
        self.reply_time = attributes[:'replyTime']
      end
    ...
    def list_invalid_properties
      ...
      if @firstname.to_s.length > 40
        invalid_properties.push("invalid value for 'firstname', the character length must be smaller than or equal to 40.")
      end
      ...
      if @lastname.to_s.length > 80
        invalid_properties.push("invalid value for 'lastname', the character length must be smaller than or equal to 80.")
      end

      if @reply_time.nil?
        invalid_properties.push("invalid value for 'reply_time', reply_time cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @firstname.to_s.length > 40
      return false if @lastname.nil?
      return false if @lastname.to_s.length > 80
      return false if @reply_time.nil?
    ...
    def firstname=(firstname)
      ...
      if firstname.to_s.length > 40
        fail ArgumentError, "invalid value for 'firstname', the character length must be smaller than or equal to 40."
      end
    ...
    def lastname=(lastname)
      ...
      if lastname.to_s.length > 80
        fail ArgumentError, "invalid value for 'lastname', the character length must be smaller than or equal to 80."
      end
    ...
    def hash
      [description, firstname, lastname, reply_time, subject].hash
    end
