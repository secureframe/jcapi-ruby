...
module JCAPIv1
  ...
  class SystemMdm
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'profileIdentifier')
        self.profile_identifier = attributes[:'profileIdentifier']
      end
      ...
      if attributes.has_key?(:'userApproved')
        self.user_approved = attributes[:'userApproved']
      end
    ...
    def valid?
      vendor_validator = EnumAttributeValidator.new('String', ["unknown", "none", "internal", "external"])
    ...
    def vendor=(vendor)
      validator = EnumAttributeValidator.new('String', ["unknown", "none", "internal", "external"])
    ...
    def hash
      [vendor, internal, profile_identifier, dep, user_approved].hash
    end
