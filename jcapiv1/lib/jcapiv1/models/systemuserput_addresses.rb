...
module JCAPIv1
  ...
  class SystemuserputAddresses
    ...
    # Custom attribute writer method with validation
    # @param [Object] extended_address Value to be assigned
    def extended_address=(extended_address)

      if !extended_address.nil? && extended_address.to_s.length > 1024
        fail ArgumentError, "invalid value for 'extended_address', the character length must be smaller than or equal to 1024."
      end
    ...
    def locality=(locality)
      ...
      if !locality.nil? && locality.to_s.length > 1024
        fail ArgumentError, "invalid value for 'locality', the character length must be smaller than or equal to 1024."
      end
    ...
    def postal_code=(postal_code)
      ...
      if !postal_code.nil? && postal_code.to_s.length > 1024
        fail ArgumentError, "invalid value for 'postal_code', the character length must be smaller than or equal to 1024."
      end
